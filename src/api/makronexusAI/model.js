...
MakronexaQA.belongsTo(UserAISettingsModel, {foreignKey:{allowNull:true,name:"dataset_id"} });
UserAISettingsModel.hasMany(MakronexaQA, {
  foreignKey: { allowNull: true, name: "dataset_id" },
});
